...
from audio_dataset_finetune import AudioDataset, AudioDataLoader
from utils.tf_logger import TF_Logger
from btc_model_finetune import *
...
if __name__ == '__main__':
    ...
    # Data loader
    train_dataset1 = AudioDataset(config, root_dir=config.path['root_path'], dataset_names=(args.dataset1,), num_workers=1, preprocessing=False, train=True, kfold=args.kfold)
    # train_dataset2 = AudioDataset(config, root_dir=config.path['root_path'], dataset_names=(args.dataset2,), num_workers=2, preprocessing=False, train=True, kfold=args.kfold)
    # train_dataset3 = AudioDataset(config, root_dir=config.path['root_path'], dataset_names=(args.dataset3,), num_workers=2, preprocessing=False, train=True, kfold=args.kfold)
