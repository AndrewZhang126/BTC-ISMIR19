...
if __name__ == '__main__':
    ...
    # Data loader
    train_dataset1 = AudioDataset(config, root_dir=config.path['root_path'], dataset_names=(args.dataset1,), num_workers=2, preprocessing=False, train=True, kfold=args.kfold)
